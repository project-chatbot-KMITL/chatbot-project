...
module.exports = function(controller) {
    ...
    controller.hears(['ไม่ได้ลงทะเบียนภายในระยะเวลาที่กำหนดไว้ในปฏิทินการศึกษา ต้องทำอย่างไร', 'ลงทะเบียนเรียนไม่ทัน','ไม่ได้ลงทะเบียนเรียน','ลืมลงทะเบียนเรียน',new RegExp(/^[A-Z\s]+$/)], ['message','direct_message'], async function(bot, message) {
    ...
    controller.hears(['ทำไมชำระเงินค่าเทอมไม่ตัดสักที','เมื่อไหร่ค่าเทอมจะตัด','ค่าเทอมจะตัดเมื่อไหร่','ค่าเทอมจะตัดตอนไหน', new RegExp(/^[A-Z\s]+$/)], ['message','direct_message'], async function(bot, message) {
    ...
    controller.hears(['ลงวิชาภาคไปตอนลงทะเบียนล่วงหน้า แต่ลงผิดกลุ่ม ต้องทำอย่างไร','ลงทะเบียนเรียนผิดกลุ่ม', new RegExp(/^[A-Z\s]+$/)], ['message','direct_message'], async function(bot, message) {
    ...
    controller.hears(['กรอกข้อมูลทุนของกองทุนการศึกษา สจล.ในระบบสารสนเทศแล้วต้องยื่นใบสมัครขอรับทุนที่ไหน','ยื่นใบสมัครทุนได้ที่ไหน','ส่งใบสมัครทุนได้ที่ไหน', new RegExp(/^[A-Z\s]+$/)], ['message','direct_message'], async function(bot, message) {
    ...
    controller.hears(['ผู้สัมภาษณ์กยศ. ต้องการเอกสารเพิ่มเติมในขณะที่สัมภาษณ์อยู่ หากผู้ถูกสัมภาษณ์ส่งเอกสารที่ต้องการเพิ่มเติมล่าช้าจะมีผลอย่างไร','ส่งเอกสารกยศ.ไม่ทัน', new RegExp(/^[A-Z\s]+$/)], ['message','direct_message'], async function(bot, message) {
...
// ทดสอบข้อคำถามที่พบบ่อย-----------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    controller.hears(['ถ้าทำบัตรนักศึกษาหาย ควรทำอย่างไร','บัตรนักศึกษาหาย','บัตรนศ.หาย', new RegExp(/^[A-Z\s]+$/)], ['message','direct_message'], async function(bot, message) {
